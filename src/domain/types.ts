...
export const PRESENCE_LOG_TYPE = ["ENTRY_DETECTED", "EXIT_DETECTED", "EXIT_CONFIRMED", "EXIT_PENDING",  "EXIT_CANCELLED", "AUTO_EXIT_TIMEOUT", "SYSTEM_RECOVERY", "MANUAL_CORRECTION", "FACE_DETECTED"] as const;
